...
time_file="/Users/allenjue/Downloads/Cs378-Concurrency/threadpool/timing/seq_timing.csv"

fail_file="/Users/allenjue/Downloads/Cs378-Concurrency/threadpool/timing/seq_fail.csv"
# Clear the file if it already exists
> $time_file
> $fail_file

echo "threads, execTime" > $time_file
echo "threads, fails" > $fail_file
...
for ((i=1; i<=10; i++)); do
  ...
  echo "$threads, $(sudo time ./threadpool -n $threads -m $mode -i $input_file)"
